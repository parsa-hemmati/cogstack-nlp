"""
Query optimization service for search performance improvements.

Provides:
- Query rewriting for better Elasticsearch performance
- Index hint suggestions
- Query complexity analysis
- Performance recommendations

Ported from: origin/development:clinical-care-tools/backend/app/services/elasticsearch/query_optimizer.py
"""
...
class QueryOptimizer:
    ...
    @staticmethod
    def _get_complexity_recommendations(score: int, breakdown: Dict[str, int]) -> List[str]:
        """
